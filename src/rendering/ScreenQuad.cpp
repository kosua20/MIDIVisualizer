...
void ScreenQuad::init(GLuint textureId, const std::string & fragShader){
	
	// Load the shaders
	_programId = createGLProgramFromStrings(ResourcesManager::getStringForShader("screenquad_vert"), fragShader);
